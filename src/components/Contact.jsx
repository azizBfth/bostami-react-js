   ...
   <div className="pt-16 px-12 mt-8">
     ...
     <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
       <div className="flex gap-4">
         <div>
         <img src="/images/phone-call 1.png" ></img>

         </div>
         <div>
           <h3 className="pb-2 text-xl font-semibold dark:text-white">Téléphone</h3>
           <p className="inline-flex flex-col gap-1">
            
             <a className="text-gray-lite text-lg dark:text-[#A6A6A6] " href="tel:+21621773258">+216 21 773 258</a>
           </p>
         </div>
       </div>
       <div className="flex gap-4">
         <div>
          <img src="/images/email 1.png" ></img>
         </div>
         <div>
           <h3 className="pb-2 text-xl font-semibold dark:text-white">Email</h3>
           <p className="inline-flex flex-col gap-1">
             <a className="text-gray-lite text-lg dark:text-[#A6A6A6] " href="mailto:omraninouha54@gmail.com"
               >omraninouha54@gmail.com</a >
     ...
     <div className="pt-6 lg:pt-20">
       ...
       >
         travaux de conception ou partenariats.
       </p>
       <form id="myForm">
